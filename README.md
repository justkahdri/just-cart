...
### **DISCLAIMER: Esta es una adaptación hecha en SvelteKit del challenge original de Goncy.**
> [Version original](https://github.com/goncy/interview-challenges/blob/main/simple-cart)
...
## Entrega 3
La Product Manager nos dijo que quieren usar esta misma lógica de carrito en otro proyecto. Debemos pasar toda la lógica de carrito de nuestro componente a un store y luego usarlo. Debe ser lo suficientemente fácil de usar y medianamente genérico como para usarlo en otros proyectos.
...
Reversionado en Svelte hecho por [Justkahdri](https://twitter.kahdri.com)